                ...
                <x-shop::form :action="route('shop.customers.account.addresses.store')">
                    ...
                    <x-shop::form.control-group>
                        <x-shop::form.control-group.label>
                            @lang('shop::app.customers.account.addresses.create.No-Antrian')
                        </x-shop::form.control-group.label>
                        ...
                        <x-shop::form.control-group.control
                            ...
                            :label="trans('shop::app.customers.account.addresses.create.No-Antrian')"
                            :placeholder="trans('shop::app.customers.account.addresses.create.No-Antrian')"
                        />
            
                        <x-shop::form.control-group.error control-name="No_Antrian" />
                    </x-shop::form.control-group>

                    {!! view_render_event('bagisto.shop.customers.account.addresses.create_form_controls.No_Antrian.after') !!}
